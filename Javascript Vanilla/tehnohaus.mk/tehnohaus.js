...
let popoverCetaForm = "Алат за работилници | Рачен алат | Авто-алат."
...
let popoverUnior = "Професионален рачен алат."
...
let popoverInsize = "Разни мерни алати и инструменти."
...
let popoverKeil = "Професионални бургии, шила, секачи и прибор."
...
let popoverKern = "Професионални машини, диамантски дискови, круни и прибор."
...
let popoverKocel = "Метален ентериер и галантерија за работилници."
...
let popoverVolkel = "Резен алат. Нарезници, врезници, коректори на навој."
...
let popoverRodcraft = "Пневматски и батериски алат и опрема за работилници."
...
let popoverPiher = "Професионални стеги за метална и дрвна индустрија."
...
let popoverAltec = "Алуминиумски мобилни скелиња."
